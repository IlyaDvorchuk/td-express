        ...
        <div>
            {!shelter.isVerified && (
                <div className={'shelter-warning'}>
                    {'В данный момент ваши документы проходят проверку, она продлится не более 30 минут.' +
                        'После ее успешного окончания вы сможете начать торговать.' +
                        'Пока что можете подготовить свой товар к продаже во вкладке "Мои товары".'}
                </div>
                )
            }
                ...
                <div className={'shelter__left'}>
                    ...
                    <div className={'shelter__news'}>
                        ...
                        <div className="news">
                            ...
                            <p>
                                {'Учитывая ключевые сценарии поведения, базовый вектор развития предопределяет высокую востребованность позиций,' +
                                    'занимаемых участниками в отношении поставленных задач. В целом, конечно, постоянный количественный рост и сфера нашей ' +
                                    'активности говорит о' +
                                    'возможностях новых предложений.'
                                }
                            </p>
                        </div>
                    </div>
