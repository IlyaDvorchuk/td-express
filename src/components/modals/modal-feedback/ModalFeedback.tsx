...
const ModalFeedback = () => {
    ...
    const onSubmit = async () => {
        ...
        const response = await UserService.createFeedback(review)
    ...
    return (
        <div className={'feedback'}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className={'feedback__cancel'}>
